...
namespace RegistroChamado.Controllers
{
    public class SetorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Status")] SetorModel setorModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Status")] SetorModel setorModel)
        {
            if (id != setorModel.Id)
            {
                return NotFound();
